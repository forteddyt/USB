		...
		for (Integer n : moves) {
			...
			case 0:
				if (!(myMaze[givenRow - 1][givenCol].equals(" ")
						|| (givenRow - 2 >= 0 && myMaze[givenRow - 2][givenCol].equals(" "))
			...
			case 1:
				if (!(myMaze[givenRow + 1][givenCol].equals(" ")
						|| (givenRow + 2 < myMaze.length && myMaze[givenRow + 2][givenCol].equals(" "))
						|| myMaze[givenRow + 1][givenCol + 1].equals(" ")
						|| myMaze[givenRow + 1][givenCol - 1].equals(" "))) {
					createPath(givenRow + 1, givenCol);
				}
			...
			case 2:
				if (!(myMaze[givenRow][givenCol - 1].equals(" ")
						|| (givenCol - 2 >= 0 && myMaze[givenRow][givenCol - 2].equals(" "))
						|| myMaze[givenRow + 1][givenCol - 1].equals(" ")
						|| myMaze[givenRow - 1][givenCol - 1].equals(" "))) {
			...
			case 3:
				if (!(myMaze[givenRow][givenCol + 1].equals(" ")
						|| (givenCol + 2 < myMaze[0].length && myMaze[givenRow][givenCol + 2].equals(" "))
						|| myMaze[givenRow + 1][givenCol + 1].equals(" ")
						|| myMaze[givenRow - 1][givenCol + 1].equals(" "))) {
					createPath(givenRow, givenCol + 1);
				}
	...
	public void createDoors() {
		...
		while (doorsMade < 2) {
			...
			if (myMaze[rRow - (rRow == 0 ? 0 : 1)][rCol] == " "
					|| myMaze[rRow + (rRow == myMaze.length ? 1 : 0)][rCol] == " "
					|| myMaze[rRow][rCol - (rCol == 0 ? 0 : 1)] == " "
					|| myMaze[rRow][rCol + (rCol == myMaze[0].length ? 1 : 0)] == " ") {
				doorable = true;
			}
